...
$(document).ready(function () {
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        $.each(datos.cct, function (key, cct) {
          $("#cct").append(
            "<option value=" + cct.id + ">" + cct.nombre + "</option>"
          );
        });
  ...
  function llenaTablaInformes(data) {
    ...
    $.each(data, function (key, informe) {
      ...
      html +=
        '<div class="text-center col-xs-4" title="Ver registros"><div class="btn-group"><button type="button" class="btn btn-info btnVer" data-cct="' +
        informe.cct +
        '" data-id_ciclo="' +
        informe.id_ciclo +
        '"  data-id_funcion="' +
      ...
      html +=
        '<div class="text-center col-xs-4" title="Imprimir cedula"><div class="btn-group"><button type="button" class="btn btn-success btnCedulas" data-cct="' +
        informe.cct +
        '" data-id_ciclo="' +
        informe.id_ciclo +
        '"  data-id_funcion="' +
      ...
      html +=
        '<div class="text-center col-xs-4" title="Imprimir gafetes"><div class="btn-group"><button type="button" class="btn btn-success btnGafetes" data-cct="' +
        informe.cct +
        '" data-id_ciclo="' +
        informe.id_ciclo +
        '"  data-id_funcion="' +
      ...
      success: function (data) {
        ...
        $.each(datos.registros, function (key, informe) {
          ...
          html +=
            ...
            "</td>" +
            "<td>" +
            informe.array_pruebas +
            "</td>";
          html +=
            '<td><div class="text-center"><div class="btn-group"><button type="button" class="btn btn-danger btnDelete" data-id="' +
            informe.id +
            '">Borrar</button></div></div></td>';
          html += "</tr>";
        });
